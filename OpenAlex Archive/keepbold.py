...
def filter_bold_topic_name(input_file="topics_art_reordered.xlsx", output_file="topics_art_filtered.xlsx"):
    ...
    try:
        topic_name_col_index = header.index("Topic Name") + 1  # openpyxl columns are 1-indexed
    except ValueError:
    ...
    for row in ws.iter_rows(min_row=2):
        topic_cell = row[topic_name_col_index - 1]  # adjust for 0-indexing in the row list
    ...
    print(f"Filtered rows saved in '{output_file}' under the sheet 'topic_art_filtered'.")
