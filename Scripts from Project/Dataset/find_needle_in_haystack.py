...
def main():
    ...
    for _, row in df.iterrows():
        ...
        # 4f) load & normalize embeddings, handling missing file gracefully
    ...
    print(
        f"✅ Processed rows {span}; wrote {len(labels)} labels into '{args.output}'.\n"
    )
