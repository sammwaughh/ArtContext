...
Fine-tune CLIP (ViT-B/32) with higher-capacity LoRA adapters on a painting dataset
to improve zero-shot description of fine art. Uses MPS if available.
Displays live progress via tqdm, saves plots of training loss &
validation InfoNCE loss over epochs, checkpoints the best model,
and reports on any missing or malformed images.
"""
...
def main():
    ...
    train_losses = []
    val_nces = []
    tau = 1.0 / model.logit_scale.exp().item()  # e.g., 0.07
