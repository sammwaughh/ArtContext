...
VISUAL_CONTENT_VERBS = [
    "depict", "depicts", "portray", "portrays", "show", "shows",
    "illustrate", "illustrates", "represent", "represents", "exhibit", "exhibits"
]
...
def extract_visual_description(query, candidate_sentences, target_word_count=100, top_n=10):
    """
    ...
    """
    ranked_sentences, confidences = rank_sentences(query, candidate_sentences, top_n=top_n)
