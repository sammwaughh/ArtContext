...
def clean_topics(input_file="openalex_topics_formatted.xlsx", output_file="openalex_topics_cleaned.xlsx"):
    ...
    df_new = df[[
        "display_name", "id", 
        "Subfield Name", "Subfield ID",
        "Field Name", "Field ID",
        "Domain Name", "Domain ID",
        "works_count", "cited_by_count", "description", "keywords"
    ]].copy()
