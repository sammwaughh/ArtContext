#!/usr/bin/env python3
"""
Generate the TOP-10 zero-shot sentences for every painting with
Vanilla-CLIP and Mint-CLIP.

Outputs two Excel workbooks (vanilla_clip.xlsx, mint_clip.xlsx)
already formatted for the averaging PR-curve script.
...
# ─── 1. metadata & caches ───
print("⚙️  Loading painter metadata …")
...
print("⚙️  Loading cached sentence embeddings …")
...
print("⚙️  Loading Mint-CLIP (LoRA) …")
...
def harvest(model: CLIPModel, out_path: pathlib.Path) -> None:
    ...
    # Apply cleaning again to any other object column that might contain stray chars
