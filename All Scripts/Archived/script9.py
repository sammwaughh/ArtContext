...
def download_papers_from_accessible(excel_file, directory_name):
    ...
    if "Accessible" not in wb.sheetnames:
        logger.warning("[WARNING] 'Accessible' sheet not found. No downloads attempted.")
        return
...
painters = [
    "caravaggio", "vermeer", "van gogh", "rembrandt", "da vinci",
    "raphael", "titian", "rubens", "el greco", "bosch",
    "poussin", "angelico", "monet", "renoir", "degas",
    "manet", "pissarro", "cezanne", "seurat", "gauguin",
    "picasso", "matisse", "dali", "kandinsky", "munch",
    "chagall", "pollock", "rothko", "o'keeffe", "hopper",
    "basquiat", "lichtenstein", "warhol", "miro", "ernst",
    "tapies", "escher", "klee", "gainsborough", "constable",
    "whistler", "courbet", "millet", "delacroix", "ingres",
    "david", "kahlo", "orozco", "rivera", "siqueiros",
    "botero", "qi", "fan", "hokusai", "hiroshige",
    "jeong", "varma", "sher-gil", "farshchian", "enwonwu",
    "repin", "ayvazovsky", "murakami", "soutine", "modigliani",
    "haring", "rossetti", "bacon", "fragonard", "bouguereau",
    "corot", "lautrec", "murillo", "sargent", "durer",
    "botticelli", "xu", "huang", "lin", "zhang",
    "klimt", "goya", "eakins", "turner", "sorolla",
    "cassatt", "chardin", "van dyck", "velazquez", "zorn",
    "holbein", "boucher", "hals", "redon", "matta",
    "ruscha", "watteau", "verrocchio", "magritte", "schiele",
    "hockney", "de chirico", "van eyck", "masaccio", "perugino",
    "morandi", "frankenthaler", "foujita", "fini", "levitan",
    "de kooning", "gervex", "boudin", "grosz", "tanguy",
    "balthus", "wu", "lee", "choi", "signac",
    "mantegna", "bellini", "giorgione", "freud", "masolino",
    "glackens", "raeburn", "kusama", "correggio", "burne-jones",
    "millais", "moreau", "bruegel", "ruisdael", "lowry",
    "poulakis", "shishkin", "hirst", "shahn", "diebenkorn",
    "leger", "kentridge", "vasari", "bronzino", "veronese",
    "altdorfer", "grunewald", "schongauer", "tiepolo", "guardi",
    "canaletto", "morisot", "liu", "hishida", "delaunay",
    "caillebotte", "pinturicchio", "allori", "pontormo", "gris",
    "rouault", "gorky", "reinhardt", "louis", "shitao",
    "guo", "liang", "roy", "kwon", "fouquet",
    "baldung", "braque", "serov", "boccioni", "carpaccio",
    "kirchner", "segantini", "domenichino", "peale", "bazille",
    "girodet", "rousseau", "bouts", "memling", "van der velde",
    "crivelli", "moholy-nagy", "opie", "johns", "beuys",
    "delvaux", "stella", "reynolds", "blake", "hodler",
    "la tour", "lissitzky", "kiefer", "parrish", "benton"
]
...
for painter in painters:
    ...
    search_unpaywall_by_title(
        joined_query, EMAIL, is_oa=None,
        max_pages=3, output_xlsx=excel_filename, wait_s=1.0
    )
