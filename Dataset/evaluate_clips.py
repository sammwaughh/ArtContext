...
def main():
    ...
    candidate_sentences = base_cached_data["candidate_sentences"]  # Assume same sentences across caches.
    ...
    base_scores = compute_contrastive_scores(candidate_embeddings_base, base_image_embedding)
    print_top_candidates("Top Candidate Sentences for Base Model:", candidate_sentences, base_scores, top_k=3)
    ...
    print_top_candidates("Top Candidate Sentences for Fine-Tuned Model:", candidate_sentences, ft_scores, top_k=3)
